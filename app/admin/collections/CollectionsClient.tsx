    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="bg-brand text-white px-6 py-2.5 rounded-lg font-bold hover:bg-brand-hover transition-colors flex items-center gap-2"
        >
          <Plus size={18} />
          إنشاء تصنيف جديد
        </button>
          ...
          <div className="relative bg-white w-full max-w-2xl rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto flex-1 flex flex-col gap-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-brand focus:ring-1 focus:ring-brand"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex rounded-lg shadow-sm" dir="ltr">
                    ...
                    <input
                      ...
                      className="w-full min-w-0 flex-1 rounded-none rounded-r-lg border-gray-300 border px-4 py-2 text-left focus:outline-none focus:border-brand"
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg resize-none focus:outline-none focus:border-brand"
            ...
            <div className="px-6 py-4 border-t border-gray-100 bg-gray-50 flex justify-end gap-3">
              ...
              <button
                ...
                className="px-6 py-2 rounded-lg font-bold bg-brand text-white hover:bg-brand-hover transition-colors disabled:opacity-50"
              >
